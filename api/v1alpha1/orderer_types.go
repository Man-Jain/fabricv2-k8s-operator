...
type OrdererSpec struct {
	...
	// Foo is an example field of Orderer. Edit Orderer_types.go to remove/update
	CommonSpec   `json:"ordererspec,omitempty"`
	GenesisBlock string `json:"genesisblock,required"`
}
